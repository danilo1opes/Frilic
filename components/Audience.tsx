  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1160px] px-6 lg:px-10">
        ...
        <h2 className="mb-10 font-heading text-4xl font-light leading-wide text-white sm:text-5xl lg:text-[58px]">
          Para quem é, e para
          <br />
          ...
          <div className="bg-surface px-8 py-10 lg:px-12 lg:py-14">
            ...
            <ul className="flex flex-col gap-4">
              {audienceYes.map((item) => (
                <li
                  key={item}
                  className="relative pl-5 text-[15px] font-normal leading-[1.5] text-text-secondary transition-colors duration-200 before:absolute before:left-0 before:text-accent before:content-['+'] hover:text-text-primary cursor-pointer"
                >
                  {item}
                </li>
              ))}
          ...
          <div className="bg-surface px-8 py-10 lg:px-12 lg:py-14">
            ...
            <ul className="flex flex-col gap-4">
              {audienceNo.map((item) => (
                <li
                  key={item}
                  className="relative pl-5 text-[15px] font-normal leading-[1.5] text-text-secondary transition-colors duration-200 before:absolute before:left-0 before:text-text-muted before:content-['×'] hover:text-text-primary cursor-pointer"
                >
                  {item}
                </li>
              ))}
